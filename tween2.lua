...
Frame.Position = UDim2.new(0.01, 0, 0.5, -115)
...
NoClipBtn.Size = UDim2.new(0, 100, 0, 25)
NoClipBtn.Position = UDim2.new(0.5, -50, 0, 205)
NoClipBtn.Text = "🔓 NOCLIP: ON"
NoClipBtn.TextScaled = true
NoClipBtn.BackgroundColor3 = Color3.fromRGB(40, 200, 80)
...
function StopNoClip()
    ...
    if Character then
        for _, part in pairs(Character:GetDescendants()) do
            if part:IsA("BasePart") then
                -- Only restore for non-HumanoidRootPart
...
-- ============================================
-- MOVE WITH NOCLIP (Pass Through Walls)
-- ============================================
